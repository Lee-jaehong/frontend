/*
    자바스크립트 데이터타입 : 원시값(number,string,boolean, undefined, null 등) 을 제외한 함수,배열도 객체 object 입니다.
                : 데이터 타입확인연산자 typeof
...
//            data.go.kr 에서 json 문자열(경랑데이터)을 제공하는 사례를 찾아보세요.

//                             REST 서비스
// 개발자       ----> data.go.kr 공개데이터 --> 서버
//              <-------- JSON 문자열을 전달 <-------------
